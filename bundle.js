...
/***/ function(module, exports, __webpack_require__) {
	...
	var _markdownInput = __webpack_require__(160);

	var _markdownInput2 = _interopRequireDefault(_markdownInput);

	var _markdownPreview = __webpack_require__(161);
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_markdownInput2.default, { onChange: function onChange(inputText) {
							return _this2.setState({ inputText: inputText });
						} }),
					_react2.default.createElement(_markdownPreview2.default, { inputText: this.state.inputText })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkdownPreview = function MarkdownPreview(_ref) {
		...
		return _react2.default.createElement(
			...
			{ className: 'col-md-6' },
			'Preview',
			_react2.default.createElement('div', { className: 'outputDiv', dangerouslySetInnerHTML: { __html: marked(inputText) } })
		);
	};
